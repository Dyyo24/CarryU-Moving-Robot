...
int turn_to_direction(float goal){
  // turn the robot to a certain degree
  // Assumption: 0 <= goal <= 360
  // return 1 means success
  // return other number means failure
...
int drive_to_destination(long goal,float dir){
...
int turn_right(float degree){
  ...
  return turn_to_direction(goal);
}

int drive_straight(int dir, int time_in_ms){
  ...
  // return 1 if success
  // return other number if failure
